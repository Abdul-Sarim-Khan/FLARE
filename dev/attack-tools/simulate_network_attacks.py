"""
FLARE v0.6 - Network Attack Simulator
──────────────────────────────────────
Injects synthetic malicious network flow rows into the flow CSV so the
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="FLARE v0.6 - Network Attack Simulator",
...
""",
    ...
    parser.add_argument(
        "--csv", default=None,
        help="Path to net_flows.csv (default: env FLARE_NET_CSV or ./net_flows.csv)",
    )
    parser.add_argument(
    ...
    print()
    print("  FLARE v0.6 - Network Attack Simulator")
    print("  " + "=" * 54)
